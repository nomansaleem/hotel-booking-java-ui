...
public class MainMenuUI extends javax.swing.JFrame {
    ...
    public void displaySearchResults(ArrayList<Booking> result){
        DefaultTableModel model = new DefaultTableModel(new String[]{"Booking Number", "Customer Number", "Apartment Number", "First Name", "Last Name", "Date Booked", "Check In Date", "Check Out Date"}, 0){
    ...
    public void displayMaintenanceSearchResults(ArrayList<Maintenance> result){
        DefaultTableModel model = new DefaultTableModel(new String[]{"Maintenance Number", "Apartment Number", "Maintenance Fault", "Maintenance Action", "Maintenance Date"}, 0){
            public boolean isCellEditable(int row, int col){ //disables editing
                return false;
            }
        };
    ...
    private void initComponents() {
        ...
        newMaintenanceBtn.setText("New Maintenance Record");
        ...
        searchMaintenanceBtn.setText("Search Maintenance Record");
        ...
        deleteMaintenanceRecord.setText("Delete Maintenance Record");
        ...
        jButton2.setText("View All Maintenance");
    ...
    private void newMaintenanceBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newMaintenanceBtnActionPerformed
        NewMaintenanceFrame frame= new NewMaintenanceFrame(this);
        frame.setVisible(true);
    ...
    private void deleteMaintenanceRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteMaintenanceRecordActionPerformed
        ...
        DAO conn= new DAO();
        conn.deleteMaintenance(maintenanceNumber);
        fetchAllMaintenance();
    ...
    private void searchMaintenanceBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchMaintenanceBtnActionPerformed
        SearchMaintenanceFrame frame= new SearchMaintenanceFrame(this);
        frame.setVisible(true);
    ...
    private void checkTasksBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkTasksBtnActionPerformed
        DAO conn= new DAO();
        ArrayList<Maintenance> result= null;
        result= conn.checkMaintenanceToday();
        DefaultTableModel model = new DefaultTableModel(new String[]{"Maintenance Number", "Apartment Number", "Maintenance Fault", "Maintenance Action", "Maintenance Date"}, 0){
            public boolean isCellEditable(int row, int col){ //disables editing
                return false;
            }
